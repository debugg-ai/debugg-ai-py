...
def handler404(*args, **kwargs):
    debugg_ai_sdk.capture_message("not found", level="error")
...
def template_test3(request, *args, **kwargs):
    traceparent = debugg_ai_sdk.get_current_scope().get_traceparent()
    if traceparent is None:
        traceparent = debugg_ai_sdk.get_isolation_scope().get_traceparent()

    baggage = debugg_ai_sdk.get_current_scope().get_baggage()
    if baggage is None:
        baggage = debugg_ai_sdk.get_isolation_scope().get_baggage()
