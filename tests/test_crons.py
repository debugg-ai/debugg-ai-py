...
@debugg_ai_sdk.monitor(monitor_slug="abc123")
def _hello_world(name):
    return "Hello, {}".format(name)


@debugg_ai_sdk.monitor(monitor_slug="def456")
...
def _hello_world_contextmanager(name):
    with debugg_ai_sdk.monitor(monitor_slug="abc123"):
        return "Hello, {}".format(name)


def _break_world_contextmanager(name):
    with debugg_ai_sdk.monitor(monitor_slug="def456"):
        1 / 0
        return "Hello, {}".format(name)
...
@debugg_ai_sdk.monitor(monitor_slug="ghi789", monitor_config=None)
def _no_monitor_config():
    return


@debugg_ai_sdk.monitor(
    monitor_slug="ghi789",
    monitor_config={
...
def test_scope_data_in_checkin(sentry_init, capture_envelopes):
    ...
    debugg_ai_sdk.add_breadcrumb(message="test breadcrumb")
    debugg_ai_sdk.set_context("test_context", {"test_key": "test_value"})
    debugg_ai_sdk.set_extra("test_extra", "test_value")
    debugg_ai_sdk.set_level("warning")
    debugg_ai_sdk.set_tag("test_tag", "test_value")
