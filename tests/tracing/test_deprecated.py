...
@pytest.mark.parametrize(
    ...
    (lambda: debugg_ai_sdk.Hub(), lambda: debugg_ai_sdk.Scope()),
)
def test_passing_hub_parameter_to_transaction_finish(
    ...
    transaction = debugg_ai_sdk.tracing.Transaction()
...
def test_no_warnings_scope_to_transaction_finish():
    ...
    with warnings.catch_warnings():
        ...
        transaction.finish(debugg_ai_sdk.Scope())
