...
from debugg_ai_sdk.consts import VERSION as SDK_VERSION
...
class LayerBuilder:
    def __init__(
        ...
        self.out_zip_filename = (
            f"debugg-ai-py-serverless-{SDK_VERSION}.zip"
    ...
    def install_python_packages(self):
        ...
        debugg_ai_python_sdk = os.path.join(
            DIST_PATH,
            f"debugg_ai_sdk-{SDK_VERSION}-py2.py3-none-any.whl",  # this is generated by "make dist" that is called by "make aws-lambda-layer"
        )
        subprocess.run(
            [
                "pip",
    ...
    def create_init_serverless_sdk_package(self):
        ...
        debugg-ai-py-serverless zip
        """
        serverless_sdk_path = (
            f"{self.python_site_packages}/debugg_ai_sdk/"
